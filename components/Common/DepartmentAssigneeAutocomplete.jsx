...
import { commonTextFieldProps, getRandomAvatarColor, ImageUrl } from "@/utils/glocalfunc";
...
export default function DepartmentAssigneeAutocomplete({
    ...
    return (
        <Box className="form-group">
            <Typography variant="caption" className="form-label" sx={{ fontWeight: 700, color: '#334155', mb: 1, display: 'block' }}>{label}</Typography>
            <Autocomplete
                multiple={multiple}
                limitTags={limitTags}
                options={options}
